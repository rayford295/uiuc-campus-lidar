...
lid = load(os.path.join(ROOT, "results", "detection", "buildings.geojson"))
o19 = load(os.path.join(ROOT, "data", "osm_buildings_2019.geojson"))
o26 = load(os.path.join(ROOT, "data", "osm_buildings_2026.geojson"))
